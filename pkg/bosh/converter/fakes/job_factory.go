...
func (fake *FakeJobFactory) BPMConfigsJob(arg1 manifest.Manifest, generation int64) (*v1alpha1.QuarksJob, error) {
...
func (fake *FakeJobFactory) InstanceGroupManifestJob(arg1 manifest.Manifest, generation int64) (*v1alpha1.QuarksJob, error) {
