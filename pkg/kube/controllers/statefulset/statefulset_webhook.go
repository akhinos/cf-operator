...
func (m *Mutator) mutateStatefulSet(ctx context.Context, statefulset *v1beta2.StatefulSet, oldStatefulset *v1beta2.StatefulSet) error {
...
func (m *Mutator) Handle(ctx context.Context, req admission.Request) admission.Response {
	...
	err = m.mutateStatefulSet(ctx, statefulset, oldStatefulset)
	if err != nil {
