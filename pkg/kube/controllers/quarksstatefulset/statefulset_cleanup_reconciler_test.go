...
var _ = Describe("ReconcileStatefulSetCleanup", func() {
	...
	BeforeEach(func() {
		...
		// A desired QuarksStatefulSet and its owned StatefulSets
		desiredQStatefulSet = &qstsv1a1.QuarksStatefulSet{
	...
	JustBeforeEach(func() {
		reconciler = qstscontroller.NewStatefulSetCleanupReconciler(ctx, config, manager)
	})
	...
	Context("when there is only one running version", func() {
		...
		It("skips the reconcile when quarksStatefulSet is not found", func() {
			client.GetCalls(func(context context.Context, nn types.NamespacedName, object runtime.Object) error {
				return apierrors.NewNotFound(schema.GroupResource{}, nn.Name)
			})
		...
		It("handles an error when getting quarksStatefulSet ", func() {
			client.GetCalls(func(context context.Context, nn types.NamespacedName, object runtime.Object) error {
				switch object.(type) {
				case *qstsv1a1.QuarksStatefulSet:
